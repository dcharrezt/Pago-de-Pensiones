...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-07-2015 a las 00:36:50
...
(1, 'ESCARBAJO', 'MANDARINNA', 'Larico', 324324, 0),
(2, 'ESCARBAJO', 'MANDARINNA', 'Larico', 324324, 0);
...
(1, 'dasds', 'YANAHUARA', 314, 0, '613', 2313),
(2, 'dasds', 'YANAHUARA', 314, 0, '613', 2313);
...
(1, 1, 1, 1, 'Nelson', 'MARCOS', 'LLLAAALA', '73047657', 'codexpsp@gmail.com', '981985895', '', '', 'Soltero', ''),
(2, 2, 2, 2, 'Nelson', 'MARCOS', 'LLLAAALA', '73047657', 'codexpsp@gmail.com', '981985895', '', '', 'Soltero', '');
...
(1, 'España', 'Arequipa', 'MARARA', '2023-12-03'),
(2, 'España', 'Arequipa', 'MARARA', '2023-12-03');
...
INSERT INTO `matriculas` (`idMatriculas`, `Estudiantes_idEstudiantes`, `Sede_idSede`, `Carrera_idCarrera`, `Turno_idTurno`, `Pagos_idPagos`, `Bancos_idBancos`, `FechaMatricula`) VALUES
(1, 2, 22, 22, 22, 2, 18, '0000-00-00');
...
INSERT INTO `pagos` (`idPagos`, `RegistroSolicitudesDescuentos_idRegistroSolicitudes`, `TipoDePago`, `Monto`) VALUES
(1, 1, '', 2000),
(2, 1, '', 2000),
(3, 1, '', 0),
(4, 1, '', 0);
...
INSERT INTO `registrosolicitudesdescuentos` (`idRegistroSolicitudes`, `Personal_idPersonal`, `Estudiantes_idEstudiantes`, `TiposSolicitud_idTiposSolicitud`, `Fecha`) VALUES
(1, 1, 2, 1, '0000-00-00');
